...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    category: Schema.Attribute.Enumeration<
      ['worship', 'community', 'youth', 'education', 'other']
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiLiveStreamLiveStream extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.String;
    endTime: Schema.Attribute.String & Schema.Attribute.DefaultTo<'11:30 AM'>;
    isActive: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
    ...
    startTime: Schema.Attribute.String & Schema.Attribute.DefaultTo<'10:30 AM'>;
    title: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    zoomLink: Schema.Attribute.String & Schema.Attribute.Required;
  };
}
